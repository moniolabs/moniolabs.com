import svgPaths from "./svg-s9s87qhvo9";
...
function Frame4() {
  return (
    <div className="content-stretch flex flex-col gap-[31px] items-start relative shrink-0 w-[93px]">
      <p className="font-['Nunito:SemiBold',sans-serif] font-semibold leading-[19.5px] min-w-full opacity-90 relative shrink-0 text-[14px] text-white tracking-[1.04px] uppercase w-[min-content]">Moniolabs</p>
      <p className="font-['Nunito:Regular',sans-serif] font-normal leading-[22.5px] min-w-full opacity-90 relative shrink-0 text-[#6e7f9e] text-[14px] w-[min-content]">Service</p>
      <Group4 />
    </div>
  );
}
...
function Frame3() {
  return (
    <div className="content-stretch flex flex-col gap-[31px] items-start relative shrink-0 text-[14px] w-[101px]">
      <p className="font-['Nunito:SemiBold',sans-serif] font-semibold leading-[19.5px] opacity-90 relative shrink-0 text-white tracking-[1.04px] uppercase w-full">ABOUT</p>
      <p className="font-['Nunito:Regular',sans-serif] font-normal leading-[22.5px] opacity-90 relative shrink-0 text-[#6e7f9e] w-full">About Us</p>
      <p className="font-['Nunito:Regular',sans-serif] font-normal leading-[22.5px] opacity-90 relative shrink-0 text-[#6e7f9e] w-full">{`Terms & Privacy`}</p>
    </div>
  );
}
...
function Frame1() {
  return (
    <div className="content-stretch flex flex-col items-start opacity-90 relative shrink-0 w-[101px]">
...
function Frame() {
  return (
    <div className="col-1 ml-0 mt-[4px] relative row-1 size-[14px]" data-name="Frame">
      <svg className="absolute block inset-0 size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 14 14">
        <g id="Frame" opacity="0.98">
          <path d={svgPaths.pdf286c0} fill="var(--fill-0, #6E7F9E)" id="Vector" />
        </g>
      </svg>
    </div>
  );
...
function Group5() {
  return (
    <div className="grid-cols-[max-content] grid-rows-[max-content] inline-grid leading-[0] opacity-90 place-items-start relative shrink-0">
      <p className="col-1 decoration-solid font-['Nunito:Regular',sans-serif] font-normal leading-[21.75px] ml-[21px] mt-0 relative row-1 text-[#6e7f9e] text-[14px] underline whitespace-nowrap">service@moniolabs.com</p>
      <Frame />
    </div>
  );
}
...
function Frame2() {
  return (
    <div className="content-stretch flex flex-col gap-[31px] items-start relative shrink-0 w-[173px]">
      <Frame1 />
      <Group5 />
    </div>
  );
...
function Frame5() {
  return (
    <div className="absolute content-stretch flex gap-[100px] items-start left-[948px] top-[44px]">
      <Frame4 />
      <Frame3 />
      <Frame2 />
    </div>
